...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str,
                        #default='/data5/1034_2group/XSY/SwinTransformer-YOLOv5-main/models/yolov5m-swint.yaml',
                        default='/data5/1034_2group/XSY/SwinTransformer-YOLOv5-main/models/mango-yolo_all.yaml',
